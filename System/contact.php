					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Beirut</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:jobboard@gmail.com">jobboard@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+961 76 123 456">+961 76 123 456</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Job Board</h5>
											<p>Job Board is a job portal, online job management system developed by Ali Mansour/Ahmad Mortada for there project</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Job Board Contact</h5>
								
								<p>Address : Beirut, Lebanon</p>
								<p>Email : <a href="jobboard@gmail.com">jobboard@gmail.com</a></p>
								<p>Phone : <a href="tel:+96176123456">+961 76 123 456</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Jobboard</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Ali Mansour/Ahmad Mortada</a></li>
								</ul>
